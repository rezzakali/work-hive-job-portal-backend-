...
const checkAuth = (req, res, next) => {
    try {
        ...
        try {
            const verified = jsonwebtoken_1.default.verify(token, app_config_1.default.JWT.SECRET);
            req.user = verified;
            next();
        }
        catch (error) {
            return next(new error_1.default('Invalid Token', http_config_1.HTTPSTATUS.FORBIDDEN));
        }
    }
    catch (error) {
