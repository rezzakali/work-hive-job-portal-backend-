...
const getJobsDetailsController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        if (!id) {
            return next(new error_1.default('Id is required to see job details', 400));
        }
        const job = yield jobModel_1.default.findById(id);
        if (!job) {
            return next(new error_1.default('Job does not exists', 404));
        }
...
const closeJobController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const userId = req.user._id;
        if (!jobId) {
            return next(new error_1.default('jobId is required!', 400));
        }
